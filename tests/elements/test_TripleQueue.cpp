...
// Auto-generated behavioral test for element: TripleQueue
...
int main() {
    ...
    SwStream out_1(64);
    KernelHarness h;
    h.start(kernel_u, std::ref(in_1), std::ref(in_2), std::ref(in_3), std::ref(out_1), std::ref(h.stop));
