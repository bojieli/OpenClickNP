...
void emitKernel(std::ostream& os, const be::Build& build,
    ...
    // Size the per-port flit arrays to the actual port count (+1 for the
    // 1-based indexing the user-side macros use). Saves ~80% of the
    // register/LUT bloat in the generated kernels for typical 1-in/1-out
    // elements.
